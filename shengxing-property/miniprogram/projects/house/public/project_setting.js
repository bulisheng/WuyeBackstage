module.exports = { //物业小区
	...
	SERVICE_ITEMS: [
		{ title: '快递代寄', desc: '上门取件，便民代办', type: '快递代寄' },
		{ title: '药品代取', desc: '按需代取，快速送达', type: '药品代取' },
	],

	CUSTOMER_FAQ: [
		{ title: '物业费怎么查', desc: '进入缴费中心查看账单。' },
		{ title: '认证审核多久', desc: '提交后请等待管理员审核。' },
		{ title: '如何发起报修', desc: '在报修页面描述问题并提交。' },
	],

	COMMUNITIES: [
		{ title: '幸福里小区', desc: '当前默认小区', current: true },
		{ title: '阳光城小区', desc: '可切换演示小区', current: false },
	],
}
