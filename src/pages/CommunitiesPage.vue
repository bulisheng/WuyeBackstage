<template>
	<section class="panel">
		...
		<div class="community-list">
			...
			<button v-if="workspace.canAction('community:delete')" class="danger" :disabled="!workspace.canAction('community:delete')" @click.stop="workspace.removeCommunity(item)">删除</button>
				</div>
			</div>
		</div>
