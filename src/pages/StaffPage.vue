			...
			<tbody>
				<tr v-for="staff in workspace.propertyStaff" :key="staff.id">
					...
					<td class="actions">
						...
						<button v-if="workspace.canAction('staff:manage')" class="danger" :disabled="!workspace.canAction('staff:manage')" @click="workspace.removePropertyStaff(staff)">删除</button>
					</td>
				</tr>
			</tbody>
		</table>
