...
export const adminApi = {
	...
	ownerDelete: (id) => request('admin/owner/delete', { id }),
	...
	tenantDelete: (id) => request('admin/tenant/delete', { id }),
	...
	staffDelete: (id) => request('admin/staff/delete', { id }),
	...
	repairStaffDelete: (id) => request('admin/repair/staff/delete', { id }),
	...
	complaintDelete: (id) => request('admin/complaint/delete', { id }),
	...
	serviceDelete: (id) => request('admin/service/delete', { id }),
	...
	activityDelete: (id) => request('admin/activity/delete', { id }),
