...
Page({
	...
	async _getSearchMenu() {
		let sortItems1 = [
			{ label: '排序', type: '', value: '' },
			{ label: '时间正序', type: 'sort', value: 'COMPLAINT_ADD_TIME|asc' },
			{ label: '时间倒序', type: 'sort', value: 'COMPLAINT_ADD_TIME|desc' }
		];
		let sortMenus = [
			{ label: '全部', type: '', value: '' },
			{ label: '待受理', type: 'status', value: '0' },
			{ label: '处理中', type: 'status', value: '1' },
			{ label: '已回复', type: 'status', value: '2' },
